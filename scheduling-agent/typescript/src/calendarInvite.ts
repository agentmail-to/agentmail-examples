 ...
 *
 * The .ics format is plain text — RFC 5545. Email clients (Gmail, Outlook,
 * Apple Mail) auto-detect text/calendar attachments and offer "Add to
 * calendar" with one click. No external service or OAuth required.
 */
...
export function buildIcs(opts: {
  ...
  const lines = [
    ...
    "CALSCALE:GREGORIAN",
    "BEGIN:VEVENT",
    `UID:${randomUUID()}@agentmail-scheduling-agent`,
